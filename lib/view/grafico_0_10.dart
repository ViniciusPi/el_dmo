...
class Grafico02 extends StatefulWidget {
  double tensaoGrafico = 0;
  Grafico02({Key? key, required this.tensaoGrafico}) : super(key: key);

  @override
  State<Grafico02> createState() => _Grafico02State();
}

class _Grafico02State extends State<Grafico02> {
